...
response.write"<script>alert('对不起，如果您已经注册，请先登陆!<br>如果您还未注册，请先注册!');history.back(-1);</script>"
response.End()
end if %>
...
sqlz="select* from wenzhang where id="&idd&""
rsz.open sqlz,conn,1
%>
<% if session("user")<>rsz("name") then
response.write"<script>alert('对不起，您无权修改本主题');history.back(-1);</script>"
response.End()
end if %>
<% rsz.close %>
<html>
<head>
<title>您可以重新编辑本主题--论坛系统</title>
...
<table width="759" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td height="24" bgcolor="#F5F5F5"><b>&gt;&gt;童真岁月论坛----主题编辑功能</b></td>
  </tr>
  <tr> 
    <td height="24" bgcolor="#FFFFFF"><font color="#FF0000"><%=rs("name")%><font color="#000000">，请重新编辑修改您的文章或主题</font></font></td>
  </tr>
</table>
<br>
<table width="759" border="0" align="center">
  <tr> 
    <td height="24" bgcolor="#F5F5F5"><img src="img/nofollow.gif" width="15" height="15"><b>编辑文章</b></td>
  </tr>
</table>
<table width="757" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td height="24" bgcolor="#F5F5F5"> 
      <form name="myform" method="post" action="articlesave.asp" onSubmit="return LoginAdd()">
        <table width="755" border="1" align="center" bordercolor="#F5F5F5">
          <tr> 
            ...
            <td width="612"> <font color="#FF0000">* 
              <input type="text" name="name" value="<%=session("user")%>"style="background-color:transparent;border:1px solid #000000" maxlength="6" size="23">
              </font></td>
          </tr>
          <tr> 
            <td width="143" bgcolor="#F5F5F5"> 
            ...
            <td width="612"> <font color="#FF0000">* 
              <input type="password" name="pwd" value="<%=session("pwd")%>"style="background-color:transparent;border:1px solid #000000" size="25">
              </font></td>
          </tr>
          <tr> 
            <td width="143" bgcolor="#F5F5F5"> 
            ...
            <td width="612"> <font color="#FF0000">* 
              <input type="text" name="title" style="background-color:transparent;border:1px solid #000000" maxlength="16" size="40" value="<%=rs("title")%>">
              </font></td>
          </tr>
          <tr> 
            <td width="143" bgcolor="#F5F5F5"> 
            ...
            <td width="612"> <font color="#FF0000">* 
              ...
              <img border="0" src="img/1.gif"> <img border="0" src="img/2.gif"> 
              <img border="0" src="img/3.gif"> <img border="0" src="img/4.gif"> 
              </font></td>
          </tr>
          <tr> 
            <td width="143" bgcolor="#F5F5F5"> 
          ...
          <tr> 
            ...
            <td rowspan="2"> <font color="#FF0000">* 
              <textarea name="GuestContent" cols="70" rows="7" id="content" style="background-color:transparent;border:1px solid #000000"><%=rs("content")%></textarea>
