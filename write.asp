...
response.write"<script>alert('对不起，您还没有登陆，如果您已经注册，请先登陆！<br>如果您还没有注册，请在本站注册！');history.back(-1);</script>"
response.End()
end if %>
...
if rs4("lock")=1 then
response.write"<script>alert('对不起，本版已经锁定，禁止发帖！');history.back(-1);</script>"
response.End()
end if
rs4.close %>
<html>
<head>
<title>发表新话题--童真岁月论坛！</title>
...
<br>
<table width="762" bordercolorlight="#FFFFFF" bordercolordark="#003399" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td bgcolor="#F5F5F5" height="24"><font color="#000000"><img src="img/nofollow.gif" width="15" height="15"><font size="2">童真岁月论坛&gt;&gt;&gt;发表话题&gt;&gt;&gt; 
      </font></font></td>
  </tr>
</table>
<form name="myform" method="post" action="save.asp" onSubmit="return LoginAdd()">
  <table width="755" border="1" align="center" bordercolor="#F5F5F5">
    <tr> 
      <td width="143" bgcolor="#F5F5F5"> 
        <div align="right">用户名称：</div>
      </td>
      <td width="612"> <font color="#FF0000">*   
        <input type="text" name="name" value="<%=session("user")%>"STYLE="background-color:transparent;border:1px solid #000000" size="23" maxlength="6">
        </font></td>
    </tr>
    <tr> 
      <td width="143" bgcolor="#F5F5F5"> 
      ...
      <td width="612"> <font color="#FF0000">*   
        <input type="password" name="pwd" value="<%=session("pwd")%>"STYLE="background-color:transparent;border:1px solid #000000" maxlength="25">
        </font></td>
    </tr>
    <tr> 
      <td width="143" bgcolor="#F5F5F5"> 
        <div align="right">话题标题：</div>
      </td>
      <td width="612"> <font color="#FF0000">*   
        <input type="text" name="title" STYLE="background-color:transparent;border:1px solid #000000" size="40" maxlength="30">
        </font></td>
    </tr>
    <tr> 
      <td width="143" bgcolor="#F5F5F5"> 
      ...
      <td width="612"> <font color="#FF0000">*   
        <select size="1" name="biaoqing">
          <option selected value="1">哈哈一笑</option>
          <option value="2">心花怒放</option>
          <option value="3">竖指称赞</option>
          <option value="4">谁比我酷</option>
        </select>
        <img border="0" src="img/1.gif"> <img border="0" src="img/2.gif"> <img border="0" src="img/3.gif">   
        <img border="0" src="img/4.gif"> </font></td>  
    </tr>
    <tr> 
      <td width="143" bgcolor="#F5F5F5"> 
    ...
    <tr> 
      <td width="143" height="25" bgcolor="#F5F5F5"> 
        <div align="right">话题内容：</div>
      </td>
      <td rowspan="2"> <font color="#FF0000">* 
        <textarea name="GuestContent" cols="70" rows="7" id="content" STYLE="background-color:transparent;border:1px solid #000000"></textarea>
        <input type="hidden" name="boardid" value="<%=request.querystring("id")%>">
    ...
    <tr> 
      <td width="143" bgcolor="#F5F5F5">&nbsp;</td>
      <td width="612"> 　　
<input type="submit" name="Submit" value="发表文章">
        <input type="reset" name="Submit2" value="取消发表">
      </td>
    </tr>
    <tr> 
