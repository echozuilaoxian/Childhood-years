...
sqlz="select* from rwenzhang where id="&idd&""
rsz.open sqlz,conn,1
%>
<% if session("user")<>rsz("rname") then
...
<table width="759" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td height="24" bgcolor="#F5F5F5"><b>&gt;&gt;童真岁月论坛----回复编辑功能</b></td>
  </tr>
  <tr> 
    <td height="24" bgcolor="#FFFFFF"><font color="#FF0000"><%=rs("rname")%><font color="#000000">，请重新编辑修改您的回复</font></font></td>
  </tr>
</table>
<br>
<table width="759" border="0" align="center">
  <tr> 
    <td height="24" bgcolor="#F5F5F5"><img src="img/nofollow.gif" width="15" height="15"><b>编辑回复</b></td>
  </tr>
</table>
<table width="757" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td height="24" bgcolor="#F5F5F5"> 
      <form name="myform" method="post" action="replysave.asp" onSubmit="return LoginAdd()">
...
sql2 = "select*from wenzhang where id="&rid&""
on error resume next 
...
%>
          ...
          <tr> 
            ...
            <td rowspan="2"> <font color="#FF0000">* 
              <textarea name="GuestContent" cols="70" rows="7" id="content" style="background-color:transparent;border:1px solid #000000"><%=rs("rcontent")%></textarea>
