...
<body text="#000000" bgcolor="#FFFFFF" topmargin="10">
...
%>
      ...
      <a href="reg.asp">注册</a> <img src="img/splt.gif" width="7" height="15" align="absmiddle"> <% user=session("user") %>
  ...
  <tr> 
    <td height="2">
      <form name="form1" method="post" action="loginok.asp">
        <table width="761" border="0" height="19" bgcolor="#F5F5F5">
          <tr> 
            <td height="19" bgcolor="#F5F5F5" width="761"> 
...
<table width="761" border="0" bordercolorlight="#FFFFFF" bordercolordark="#003399" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="22" bgcolor="#F5F5F5"><font size="2" color="#000000"><img src="img/BMsg.gif" width="16" height="16"><b>::最新帖子&gt;&gt;&gt;</b></font></td>
    <td height="22" bgcolor="#F5F5F5"><font size="2" color="#000000"><img src="img/BMsg.gif" width="16" height="16"><b>::精华贴子&gt;&gt;&gt;</b></font></td>
  </tr>
  <tr> 
...
%>
      ...
      <table width="394" border="0" height="15">
        <tr> 
          <td bgcolor="#FAFAFA"><font size="2" color="#000000"><img src="img/nofollow.gif" width="15" height="15"><a href="show.asp?id=<%=rsx("id")%>"><%=server.htmlencode(rsx("title"))%></a></font></td>
        </tr>
      </table>
...
%>
      ...
      <table width="368" border="0" height="15">
        <tr> 
          <td bgcolor="#FAFAFA"><font size="2" color="#000000"><img src="img/nofollow.gif" width="15" height="15"><a href="show.asp?id=<%=rsj("id")%>"><%=server.htmlencode(rsj("title"))%></a></font></td>
        </tr>
      </table>
      <font size="2" color="#000000"> 
      <% rsj.movenext
...
<table width="764" border="0" bordercolorlight="#FFFFFF" bordercolordark="#CCFFCC" align="center" bordercolor="#003399">
  <tr> 
    <td bgcolor="#F5F5F5" height="24"><font color="#000000"><img src="img/nofollow.gif" width="15" height="15"><font size="2"><b>童真岁月论坛&gt;&gt;&gt;所有版块&gt;&gt;&gt;</b> 
      <% dim rst       
dim sqlt
...
<table width="763" border="0" bordercolorlight="#FFFFFF" bordercolordark="#CCFFCC" cellspacing="0" cellpadding="0" align="center" bordercolor="#003399" height="19">
  <tr> 
    <td bgcolor="#F5F5F5" height="14" width="528"><font size="2" color="#FFFFFF">[</font><font size="2" color="#000000"><img src="img/nofollow.gif" width="15" height="15"></font><font size="2" color="#FFFFFF">]</font><font size="2" color="#000000"><b>==<%=rst("typename")%>==</b></font><font size="2" color="#FFFFFF"><%=rst("id")%></font></td>
    <td height="14" width="235" bgcolor="#F5F5F5">&nbsp;</td>
  </tr>
</table>
<% idd=rst("id") %>
...
<table width="763" border="1" bordercolorlight="#FFFFFF" bordercolordark="#CCFFCC" cellspacing="0" align="center" bordercolor="#F5F5F5" height="31" cellpadding="0">
  <tr bgcolor="#FFFFFF" bordercolor="#F5F5F5"> 
    ...
    <td height="39" width="451"> 
      <table width="447" style="word-break:break-all" border="0" height="37">
        <tr> 
          <td height="32" width="393"><font size="2" color="#000000"><img src="img/Forum_readme.gif" width="10" height="10">※<a href=board.asp?id=<%=rs("id")%>><%=rs("boardname")%></a>※</font></td>
          <td height="50" rowspan="2" width="54"> 
            <div align="right"><font color="#000000"><img src="img/<%=rs("ico")%>" border="1" width="49" height="51"></font></div>
          </td>
        </tr>
        <tr> 
          <td height="18" style="word-break:break-all" width="393"><font size="2" color="#000000"><%=rs("boardcontent")%></font></td>
        </tr>
      </table>
    </td>
...
rs2.update
%>
<table width="762" border="1" bordercolorlight="#FFFFFF" bordercolordark="#CCFFCC" cellspacing="0" cellpadding="0" align="center" bordercolor="#F5F5F5">
  <tr bgcolor="#F5F5F5" bordercolor="#F5F5F5"> 
    <td height="26" colspan="2"><font color="#000000"><img src="img/nofollow.gif" width="15" height="15"><b>童真岁月论坛&gt;&gt;&gt;在线统计&gt;&gt;&gt;</b> 
      <%
...
%>
  ...
  <tr bordercolor="#F5F5F5"> 
    <td height="66" width="32"> 
      <div align="center"><img src="img/totel.gif" width="23" height="23"></div>
    </td>
    <td height="66" width="724"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="60%">■目前本论坛在线共<%=Application("num")%>人，总访问量<%=rs2("num")%>人次，<a href="user.asp" 
...
<table width="762" border="1" bordercolorlight="#FFFFFF" bordercolordark="#CCFFCC" cellspacing="0" cellpadding="0" align="center" bordercolor="#F5F5F5">
  <tr > 
    <td height="26" bgcolor="#F5F5F5" bordercolor="#F5F5F5"><font color="#000000"><img src="img/nofollow.gif" width="15" height="15"><b>童真岁月论坛&gt;&gt;&gt;友情链接&gt;&gt;&gt; 
      </b> </font></td>
  </tr>
  <tr> 
